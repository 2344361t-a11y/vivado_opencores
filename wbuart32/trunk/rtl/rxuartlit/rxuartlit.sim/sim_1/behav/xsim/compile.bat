...
REM
REM Generated by Vivado on Wed Jun 03 15:38:58 +0900 2026
...
echo "xvlog --incr --relax -prj tb_rxuartlite_simple_fixed_vlog.prj"
call xvlog  --incr --relax -prj tb_rxuartlite_simple_fixed_vlog.prj -log xvlog.log
