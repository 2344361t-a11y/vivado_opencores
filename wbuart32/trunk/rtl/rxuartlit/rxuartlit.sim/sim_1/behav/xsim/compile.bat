...
REM
REM Generated by Vivado on Wed Jun 03 12:35:30 +0900 2026
...
echo "xvlog --incr --relax -prj rxuartlite_vlog.prj"
call xvlog  --incr --relax -prj rxuartlite_vlog.prj -log xvlog.log
