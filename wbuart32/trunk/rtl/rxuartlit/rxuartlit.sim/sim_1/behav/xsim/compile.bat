...
REM
REM Generated by Vivado on Wed Jun 03 19:31:19 +0900 2026
...
echo "xvlog --incr --relax -prj tb_rxuartlite_normal_only_vlog.prj"
call xvlog  --incr --relax -prj tb_rxuartlite_normal_only_vlog.prj -log xvlog.log
