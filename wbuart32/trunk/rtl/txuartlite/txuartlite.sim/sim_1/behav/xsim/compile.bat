...
REM
REM Generated by Vivado on Fri Jun 05 12:49:12 +0900 2026
...
echo "xvlog --incr --relax -prj tb_txuartlite_vlog.prj"
call xvlog  --incr --relax -prj tb_txuartlite_vlog.prj -log xvlog.log
