...
REM
REM Generated by Vivado on Fri Jun 05 14:01:21 +0900 2026
...
echo "xvlog --incr --relax -prj tb_txuartlite_case1_only_20260605_1330_vlog.prj"
call xvlog  --incr --relax -prj tb_txuartlite_case1_only_20260605_1330_vlog.prj -log xvlog.log
