...
REM
REM Generated by Vivado on Thu Jun 04 15:15:18 +0900 2026
...
echo "xvlog --incr --relax -prj tb_rxuartlite_vlog.prj"
call xvlog  --incr --relax -prj tb_rxuartlite_vlog.prj -log xvlog.log
